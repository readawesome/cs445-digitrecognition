...
def main():
    ...
    #parser.add_argument('--img_file', help='Image used for inference.', type=Path, default='../data/4321-2.png')
    parser.add_argument('--img_file', help='Image used for inference.', type=Path, default='img.png')
...
if __name__ == '__main__':
    start_server(main, port=32420, debug=True)
    main()
